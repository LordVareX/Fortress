...
#include "DynamoDBError.h"

#include "Model/AWSDynamoDBBatchExecuteStatementRequest.h"
#include "Model/BatchGetItemRequest.h"
#include "Model/BatchWriteItemRequest.h"
#include "Model/CreateBackupRequest.h"
#include "Model/CreateGlobalTableRequest.h"
...
#include "Model/DescribeContinuousBackupsRequest.h"
#include "Model/DescribeContributorInsightsRequest.h"
#include "Model/DescribeEndpointsRequest.h"
#include "Model/AWSDynamoDBDescribeExportRequest.h"
#include "Model/DescribeGlobalTableRequest.h"
#include "Model/DescribeGlobalTableSettingsRequest.h"
#include "Model/AWSDynamoDBDescribeKinesisStreamingDestinationRequest.h"
#include "Model/DescribeLimitsRequest.h"
#include "Model/DescribeTableRequest.h"
#include "Model/DescribeTableReplicaAutoScalingRequest.h"
#include "Model/DescribeTimeToLiveRequest.h"
#include "Model/AWSDynamoDBDisableKinesisStreamingDestinationRequest.h"
#include "Model/AWSDynamoDBEnableKinesisStreamingDestinationRequest.h"
#include "Model/AWSDynamoDBExecuteStatementRequest.h"
#include "Model/AWSDynamoDBExecuteTransactionRequest.h"
#include "Model/AWSDynamoDBExportTableToPointInTimeRequest.h"
#include "Model/GetItemRequest.h"
#include "Model/ListBackupsRequest.h"
#include "Model/ListContributorInsightsRequest.h"
#include "Model/AWSDynamoDBListExportsRequest.h"
#include "Model/ListGlobalTablesRequest.h"
#include "Model/ListTablesRequest.h"
#include "Model/ListTagsOfResourceRequest.h"
#include "Model/PutItemRequest.h"
#include "Model/QueryRequest.h"
#include "Model/RestoreTableFromBackupRequest.h"
#include "Model/RestoreTableToPointInTimeRequest.h"
#include "Model/ScanRequest.h"
#include "Model/DynamoDBTagResourceRequest.h"
#include "Model/TransactGetItemsRequest.h"
#include "Model/TransactWriteItemsRequest.h"
#include "Model/DynamoDBUntagResourceRequest.h"
#include "Model/UpdateContinuousBackupsRequest.h"
#include "Model/UpdateContributorInsightsRequest.h"
#include "Model/UpdateGlobalTableRequest.h"
#include "Model/UpdateGlobalTableSettingsRequest.h"
#include "Model/UpdateItemRequest.h"
#include "Model/UpdateTableRequest.h"
#include "Model/UpdateTableReplicaAutoScalingRequest.h"
#include "Model/UpdateTimeToLiveRequest.h"

#include "Model/AWSDynamoDBBatchExecuteStatementResult.h"
#include "Model/BatchGetItemResult.h"
#include "Model/BatchWriteItemResult.h"
#include "Model/CreateBackupResult.h"
#include "Model/CreateGlobalTableResult.h"
...
#include "Model/DescribeContinuousBackupsResult.h"
#include "Model/DescribeContributorInsightsResult.h"
#include "Model/DescribeEndpointsResult.h"
#include "Model/AWSDynamoDBDescribeExportResult.h"
#include "Model/DescribeGlobalTableResult.h"
#include "Model/DescribeGlobalTableSettingsResult.h"
#include "Model/AWSDynamoDBDescribeKinesisStreamingDestinationResult.h"
#include "Model/DescribeLimitsResult.h"
#include "Model/DescribeTableResult.h"
#include "Model/DescribeTableReplicaAutoScalingResult.h"
#include "Model/DescribeTimeToLiveResult.h"
#include "Model/AWSDynamoDBDisableKinesisStreamingDestinationResult.h"
#include "Model/AWSDynamoDBEnableKinesisStreamingDestinationResult.h"
#include "Model/AWSDynamoDBExecuteStatementResult.h"
#include "Model/AWSDynamoDBExecuteTransactionResult.h"
#include "Model/AWSDynamoDBExportTableToPointInTimeResult.h"
#include "Model/GetItemResult.h"
#include "Model/ListBackupsResult.h"
#include "Model/ListContributorInsightsResult.h"
#include "Model/AWSDynamoDBListExportsResult.h"
#include "Model/ListGlobalTablesResult.h"
#include "Model/ListTablesResult.h"
#include "Model/ListTagsOfResourceResult.h"
#include "Model/PutItemResult.h"
#include "Model/QueryResult.h"
#include "Model/RestoreTableFromBackupResult.h"
#include "Model/RestoreTableToPointInTimeResult.h"
#include "Model/ScanResult.h"
#include "Model/TransactGetItemsResult.h"
#include "Model/TransactWriteItemsResult.h"
#include "Model/UpdateContinuousBackupsResult.h"
#include "Model/UpdateContributorInsightsResult.h"
#include "Model/UpdateGlobalTableResult.h"
#include "Model/UpdateGlobalTableSettingsResult.h"
#include "Model/UpdateItemResult.h"
#include "Model/UpdateTableResult.h"
#include "Model/UpdateTableReplicaAutoScalingResult.h"
#include "Model/UpdateTimeToLiveResult.h"
...
#include "DynamoDBClientObject.generated.h"
...
class DYNAMODB_API UDynamoDBClientObject : public UObject {
    GENERATED_BODY()

public:
#if WITH_DYNAMODBCLIENTSDK && WITH_CORE
    Aws::DynamoDB::DynamoDBClient *awsDynamoDBClient;
#endif

    /**
    * public static UDynamoDBClientObject::CreateDynamoDBObject
    * Creates a DynamoDBClientObject. This function must be called first before accessing any Dynamo DB client functions.
    * @param credentials [FAWSCredentials] .
    * @param clientConfiguration [FClientConfiguration] .
    * @return [UDynamoDBClient*] Returns UDynamoDBClient*.
    **/
    UFUNCTION(BlueprintCallable, Category = "DynamoDB Client")
    static UDynamoDBClientObject *
    CreateDynamoDBObject(const FAWSCredentials &credentials, const FAWSClientConfiguration &clientConfiguration);

    /**
    *  <p> This operation allows you to perform batch reads and writes on data stored in DynamoDB, using PartiQL. </p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/BatchExecuteStatement">AWS API Reference</a></p>
    ...
    **/
    UFUNCTION(BlueprintCallable,
          ...
          Category = "DynamoDB Client")
    void BatchExecuteStatement (
    ...
    **/
    ...
    /**
    *  <p>Deletes an existing backup of a table.</p> <p>You can call <code>DeleteBackup</code> at a maximum rate of 10 times per second.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DeleteBackup">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Deletes a single item in a table by primary key. You can perform a conditional delete operation that deletes the item if it exists, or if it has an expected attribute value.</p> <p>In addition to deleting an item, you can also return the item's attribute values in the same operation, using the <code>ReturnValues</code> parameter.</p> <p>Unless you specify conditions, the <code>DeleteItem</code> is an idempotent operation; running it multiple times on the same item or attribute does <i>not</i> result in an error response.</p> <p>Conditional deletes are useful for deleting items only if specific conditions are met. If those conditions are met, DynamoDB performs the delete. Otherwise, the item is not deleted.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DeleteItem">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Describes an existing backup of a table.</p> <p>You can call <code>DescribeBackup</code> at a maximum rate of 10 times per second.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeBackup">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Checks the status of continuous backups and point in time recovery on the specified table. Continuous backups are <code>ENABLED</code> on all tables at table creation. If point in time recovery is enabled, <code>PointInTimeRecoveryStatus</code> will be set to ENABLED.</p> <p> After continuous backups and point in time recovery are enabled, you can restore to any point in time within <code>EarliestRestorableDateTime</code> and <code>LatestRestorableDateTime</code>. </p> <p> <code>LatestRestorableDateTime</code> is typically 5 minutes before the current time. You can restore your table to any point in time during the last 35 days. </p> <p>You can call <code>DescribeContinuousBackups</code> at a maximum rate of 10 times per second.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeContinuousBackups">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Returns information about contributor insights, for a given table or global secondary index.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeContributorInsights">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    meta = (Latent, LatentInfo = "LatentInfo", HidePin = "WorldContextObject", DefaultToSelf = "WorldContextObject"),
    Category = "DynamoDB Client")
    void DescribeContributorInsights (
        UObject *WorldContextObject,
        bool &success,
    ...
    /**
    *  <p>Returns the regional endpoint information.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeEndpoints">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Describes an existing table export.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeExport">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Returns information about the specified global table.</p>  <p>This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29</a> of global tables. If you are using global tables <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html">Version 2019.11.21</a> you can use <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_DescribeTable.html">DescribeTable</a> instead.</p> <p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeGlobalTable">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Describes Region-specific settings for a global table.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeGlobalTableSettings">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Returns information about the status of Kinesis streaming.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeKinesisStreamingDestination">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Gives a description of the Time to Live (TTL) status on the specified table. </p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DescribeTimeToLive">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Stops replication from the DynamoDB table to the Kinesis data stream. This is done without deleting either of the resources.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DisableKinesisStreamingDestination">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Starts table data replication to the specified Kinesis data stream at a timestamp chosen during the enable workflow. If this operation doesn't return results immediately, use DescribeKinesisStreamingDestination to check if streaming to the Kinesis data stream is ACTIVE.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/EnableKinesisStreamingDestination">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p> This operation allows you to perform reads and singleton writes on data stored in DynamoDB, using PartiQL. </p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ExecuteStatement">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p> This operation allows you to perform transactional reads or writes on data stored in DynamoDB, using PartiQL. </p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ExecuteTransaction">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Exports table data to an S3 bucket. The table must have point in time recovery enabled, and you can export data from any time within the point in time recovery window.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ExportTableToPointInTime">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>The <code>GetItem</code> operation returns a set of attributes for the item with the given primary key. If there is no matching item, <code>GetItem</code> does not return any data and there will be no <code>Item</code> element in the response.</p> <p> <code>GetItem</code> provides an eventually consistent read by default. If your application requires a strongly consistent read, set <code>ConsistentRead</code> to <code>true</code>. Although a strongly consistent read might take more time than an eventually consistent read, it always returns the last updated value.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/GetItem">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Returns a list of ContributorInsightsSummary for a table and all its global secondary indexes.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ListContributorInsights">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Lists completed exports within the past 90 days.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ListExports">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Lists all global tables that have a replica in the specified Region.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ListGlobalTables">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Returns an array of table names associated with the current account and endpoint. The output from <code>ListTables</code> is paginated, with each page returning a maximum of 100 table names.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ListTables">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>List all tags on an Amazon DynamoDB resource. You can call ListTagsOfResource up to 10 times per second, per account.</p> <p>For an overview on tagging DynamoDB resources, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Tagging.html">Tagging for DynamoDB</a> in the <i>Amazon DynamoDB Developer Guide</i>.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ListTagsOfResource">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Creates a new table from an existing backup. Any number of users can execute up to 4 concurrent restores (any type of restore) in a given account. </p> <p>You can call <code>RestoreTableFromBackup</code> at a maximum rate of 10 times per second.</p> <p>You must manually set up the following on the restored table:</p> <ul> <li> <p>Auto scaling policies</p> </li> <li> <p>IAM policies</p> </li> <li> <p>Amazon CloudWatch metrics and alarms</p> </li> <li> <p>Tags</p> </li> <li> <p>Stream settings</p> </li> <li> <p>Time to Live (TTL) settings</p> </li> </ul><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/RestoreTableFromBackup">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Updates the status for contributor insights for a specific table or index.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/UpdateContributorInsights">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
    ...
    **/
    ...
    /**
    *  <p>Updates settings for a global table.</p><p><h3>See Also:</h3>   <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/UpdateGlobalTableSettings">AWS API Reference</a></p>
    *  Queues the request into a thread executor and triggers associated callback when operation has finished.
    * @param
