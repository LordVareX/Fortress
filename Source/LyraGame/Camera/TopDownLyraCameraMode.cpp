...
#include "Camera/TopDownLyraCameraMode.h"
...
UTopDownLyraCameraMode::UTopDownLyraCameraMode()
{
...
void UTopDownLyraCameraMode::UpdateView(float DeltaTime)
{
...
FRotator UTopDownLyraCameraMode::GetDesiredRotation() const
{
	return GetComponentRotation();
}

FRotator UTopDownLyraCameraMode::GetTargetRotation() const
{
...
void UTopDownLyraCameraMode::UpdateDesiredArmLocation(bool bDoTrace, bool bDoLocationLag, bool bDoRotationLag, float DeltaTime)
{
...
FVector UTopDownLyraCameraMode::BlendLocations(const FVector& DesiredArmLocation, const FVector& TraceHitLocation, bool bHitSomething, float DeltaTime)
{
	return bHitSomething ? TraceHitLocation : DesiredArmLocation;
}

void UTopDownLyraCameraMode::ApplyWorldOffset(const FVector& InOffset, bool bWorldShift)
{
...
void UTopDownLyraCameraMode::OnRegister()
{
	Super::OnRegister();
...
void UTopDownLyraCameraMode::PostLoad()
{
	Super::PostLoad();
}

void UTopDownLyraCameraMode::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	Super::TickComponent(DeltaTime, TickType, ThisTickFunction);
	UpdateDesiredArmLocation(bDoCollisionTest, bEnableCameraLag, bEnableCameraRotationLag, DeltaTime);
}

FTransform UTopDownLyraCameraMode::GetSocketTransform(FName InSocketName, ERelativeTransformSpace TransformSpace) const
{
...
bool UTopDownLyraCameraMode::HasAnySockets() const
{
	return true;
}

void UTopDownLyraCameraMode::QuerySupportedSockets(TArray<FComponentSocketDescription>& OutSockets) const
{
	new (OutSockets) FComponentSocketDescription(SocketName, EComponentSocketType::Socket);
}

FVector UTopDownLyraCameraMode::GetUnfixedCameraPosition() const
{
	return UnfixedCameraPosition;
}

bool UTopDownLyraCameraMode::IsCollisionFixApplied() const
{
